...
public class inbox_fragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, MessagesAdapter.MessageAdapterListener,SearchView.OnQueryTextListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final SpeedDialView mSpeedDialView=view.findViewById(R.id.speedDial);
        SpeedDialOverlayLayout overlayLayout = view.findViewById(R.id.overlay);
        mSpeedDialView.setOverlayLayout(overlayLayout);
        mSpeedDialView.addActionItem(new SpeedDialActionItem.Builder(R.id.compose,R.drawable.ic_edit_blue_24dp)
                ...
                .setLabelBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.label_back,getActivity().getTheme()))
    ...
    private void getInbox()
    {
        ...
        df.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    if(s.child("isread").getValue().toString().equals("true")) {
    ...
    public void onMessageRowClicked(int position) {
        if (mAdapter.getSelectedItemCount() > 0) {
            ...
            Collections.sort(messages);
            mAdapter.notifyDataSetChanged();
            Intent s=new Intent(getActivity(),allmails.class);
            s.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            s.putExtra("user",message.getFrom());
            startActivity(s);
